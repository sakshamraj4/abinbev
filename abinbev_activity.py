...
def generate_summary(data):
    ...
    summary_data = {
        ...
        'Sown seed/Total plot area (kg/Bigha)': 8.01,
        'Percentage of Farms in Tillering Stage': 89.8,
        'Percentage of Farms in Germination Stage': 10.2,
        ...
        'Percentage of Farms on which Irrigation 1 is done': 29,
